...
class HomeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, GADBannerViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        tracker.set(kGAIScreenName, value: "New song page")
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Жаңа әндер"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        homeTimer = Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(self.updatePlayerTime), userInfo: nil, repeats: true)
